...
if __name__ == "__main__":
    ...
    main(data=path, mode="bootstrap_test", dropout=0.0, rec_dropout=0.2, depth=1, batch_size=32, dim=96, epochs=2,
         balanced_sample=False, lr=0.001, percentage=None, verbose=0,
         load_state="")
