...
def main(data='../data/in-hospital-mortality/', output_dir='.', dim=256, depth=1, epochs=3,
    ...
    model = Network(dim=dim, batch_norm=batch_norm, dropout=dropout, rec_dropout=rec_dropout, task='ihm',
                    num_classes=1, depth=depth, input_dim=input_dim)
    ...
    if mode == 'train':
        ...
        metrics_callback = metrics.InHospitalMortalityMetrics(train_data=train_raw, val_data=val_raw,
