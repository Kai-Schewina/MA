...
def main(data, timestep=1.0, normalizer_state="./ihm_ts_1.00_impute_previous_start_zero_masks_True_n_20918.normalizer",
         small_part=False):
    ...
    with open("../data/in-hospital-mortality_v3/train_raw.pkl", "wb") as f:
        pickle.dump(train_raw, f)
    with open("../data/in-hospital-mortality_v3/val_raw.pkl", "wb") as f:
        pickle.dump(val_raw, f)
    with open("../data/in-hospital-mortality_v3/test.pkl", "wb") as f:
        pickle.dump(test, f)


if __name__ == "__main__":
    main(data="../data/in-hospital-mortality_v3/")
